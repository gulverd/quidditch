            ...
            <div class="container"> 
                <div class="col-md-12 wrpa_auth">
                    <div class="col-md-12 auth_title_wrp">
                        <h3>ინფორმაცია გადახდის შესახებ</h3>             	
                       	<h4>ოპერაცია წარმატებით განხორციელდა.</p>
                       	<p>ცვლილებების შესატანათ გთხოვთ გაიაროთ ხელახალი <a href="auth.php">ავტორიზაცია</a>.</p>
                    </div>
                </div>
            </div>
        </div>
